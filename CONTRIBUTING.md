...
This explains how to propose a change to mypkg via a pull request using
Git and GitHub. 
...
someone from the tidyverse team agrees that it鈥檚 a problem, and is happy with
your basic proposal for fixing it. If you鈥檝e found a bug, first create a minimal
...
the [mypkg GitHub repo](https://github.com/BruceZhaoR/mypkg), and 
...
results for [mypkg on Travis](https://travis-ci.org/BruceZhaoR/mypkg) (checks on Linux and/or 
...
* [dplyr鈥檚 `NEWS.md`](https://github.com/tidyverse/dplyr/blob/master/NEWS.md) is
